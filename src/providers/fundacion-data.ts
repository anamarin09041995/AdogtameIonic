...
export class FundacionData {
  ...
  loadData(){
    this.data = [
      {nombre: 'Igualad animal', direccion: 'Avenida Panamericada # 6-35', telefono:3124457879, imagen: '../assets/img/igualdadanimal.jpg', descripcion:'Se requieren personas dispuestas a colaborar en labores como el baño de las mascotas, incluyendo sus camas y cobijas' },
